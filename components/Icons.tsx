...
export const LanguageIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="m10.5 21 5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 0 1 .428 6.337A48.454 48.454 0 0 1 3 18.255M5.25 5.621A37.453 37.453 0 0 1 11.91 11.25m8.369 7.005a37.453 37.453 0 0 1-8.37-5.63M3.75 9.75h16.5M4.5 12h15M5.25 14.25h13.5" />
  </svg>
);

export const GlobeAltIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c.248 0 .452-.204.452-.455V3.455c0-.251-.204-.455-.452-.455M12 3c-.248 0-.452.204-.452.455v17.09c0 .251.204.455.452.455M12 3a9.004 9.004 0 0 0-8.716 6.747M12 3a9.004 9.004 0 0 1 8.716 6.747m-17.432 0h17.432M5.25 9h13.5" />
  </svg>
);
